...
const whitelist = ['http://'+ process.env.APP_HOST + ':' + process.env.APP_PORT, undefined]
...
module.exports = function (app) {
    ...
    app.use('/api/user', require('../routes/home'))

    app.use('/api/user', require('../routes/card'))

    app.use('/api/user', require('../routes/table'))

    app.use('/api/user', require('../routes/profil'))

    app.use('/api/user', require('../routes/service'))
